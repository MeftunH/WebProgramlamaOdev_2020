#pragma checksum "C:\Users\Eren Değirmenci\Source\Repos\erendgrmnc\WebOdev\WebProje\WebProje\Views\NewPokemon\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9a49695cc731bcf63a667d29279f12e40c64f10b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9a49695cc731bcf63a667d29279f12e40c64f10b", @"/Views/NewPokemon/Index.cshtml")]
...
");
            WriteLiteral(@"            let isTypeAdded = false;
            let typeID = """";
            let typeName = """";
    ...
    function selectWeakness() {
        $('#select-weakness-button').on('click', function () {
            ...
            ");
            WriteLiteral(@"else if (isWeaknessAdded == true) {
                swal({
                    title: ""Tip Eklenemedi!"",
    ...
    function selectAbility() {
        $('#select-ability-button').on('click', function () {
            ...
            if (isAbilityAdded == false) {
                let $newDiv = $('<div class=""mx-2 selected-type-container-click"" dat");
            WriteLiteral(@"a-abilityid=""' + abilityID + '"">' + abilityName + '</div');
    ...
    function removeSelectedType() {
        $('.selected-type-container-click').click(function () {
            alert(""tıklandı !"");
        });
    }
</script>
